layui.define([ 'jquery','http'], function(exports) {
    ...
    var MOD_NAME = 'image', $ = layui.jquery , layer = layui.layer , http = layui.http
    ...
    Cupload.prototype = {
        ...
        uploadImage: function () {
            ...
            var option = {};
            option.url = '/admin/api/uploadImage';
            option.type = 'POST'
            option.processData = false
            option.contentType = false
            option.data = formData
            http.ajax(option).done(function(res){
                _this.limitedWidthAndHeight(res.data.path, file.name)
            }).fail(function(error){
